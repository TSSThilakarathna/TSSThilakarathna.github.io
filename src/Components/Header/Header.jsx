...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-30 bg-opacity-70 backdrop-blur-md px-[30px] sm:px-18 md:px-16 lg:px-24 py-4 sm:py-5 flex justify-between items-center">
      <img
