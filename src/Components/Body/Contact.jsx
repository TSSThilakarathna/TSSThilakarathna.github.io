    ...
    <div id="contact" className="relative top-[350px] flex justify-center px-4">
      <div className="w-full max-w-[1100px] flex flex-col md:flex-row items-center justify-center gap-2 sm:gap-8 md:gap-10 p-10">
        ...
        <div className="w-full md:w-[50%] h-auto p-6 sm:p-8 md:p-10 rounded-[20px] sm:rounded-[30px] text-center md:text-left">
          <h1 className="text-lg sm:text-xl md:text-3xl font-semibold text-[#DCD5EB]">
            Get In Touch
          </h1>
          <p className="text-sm sm:text-base md:text-lg mt-4 text-[#928D9B]">
            Got questions, feedback, or just want to say hello? We're all ears! Reach out to us and let's start a conversation.
          </p>

          <div className="flex justify-center md:justify-start gap-4 mt-6">
            <a href="https://www.linkedin.com/in/sachin-thilakarathna-b7827727b/" className="text-[#797874] hover:text-white text-xl" target="_blank" rel="noopener noreferrer"><FaLinkedin /></a>
            <a href="https://www.behance.net/tss11" className="text-[#797874] hover:text-white text-xl" target="_blank" rel="noopener noreferrer"><FaBehance /></a>
            <a href="https://github.com/SachinThilakarathna" className="text-[#797874] hover:text-white text-xl" target="_blank" rel="noopener noreferrer"><FaGithub /></a>
            <a href="https://www.instagram.com/sachn.thilakarathna/?hl=en" className="text-[#797874] hover:text-white text-xl" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
            <a href="#" className="text-[#797874] hover:text-white text-xl"><FaTwitter /></a>
            <a href="https://web.facebook.com/sachin.thilakarathna" className="text-[#797874] hover:text-white text-xl" target="_blank" rel="noopener noreferrer"><FaFacebook /></a>
          </div>
        </div>
